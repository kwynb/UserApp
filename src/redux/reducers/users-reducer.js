import {ON_GET_USERLIST_ACTION,ON_GET_USER_ACTION, ON_GET_USER_BY_USERNAME_ACTION, ON_UPDATE_USER_ACTION} from "../actions/user-action";

const getDefaultState = () => ({ users: [], user: {}});
